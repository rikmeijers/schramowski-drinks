    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav ms-auto">
                @if(auth()->check())
                    <li class="nav-item">
                        <a class="nav-link px-3 py-2 rounded-pill me-2 home {{ request()->routeIs('home') ? 'active' : '' }}" href="{{ route('home') }}">Übersicht</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link px-3 py-2 rounded-pill me-2 {{ (request()->routeIs('rental-orders.*') && !request()->routeIs('rental-orders.create')) ? 'active' : '' }}" href="{{ route('rental-orders.index') }}">Vermietung</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link px-3 py-2 rounded-pill me-2 {{ request()->routeIs('rental-orders.create') ? 'active' : '' }}" href="{{ route('rental-orders.create') }}">Neue Vermietung</a>
                    </li>
