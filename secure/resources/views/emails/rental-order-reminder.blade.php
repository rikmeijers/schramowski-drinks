...
@section('content')
    <h2 style="margin:0 0 12px 0;">Erinnerung: Rückgabe Vermietung #{{ $order->id }}</h2>

    <p style="margin:0 0 12px 0;">Das ist eine Erinnerung: Die Vermietung sollte bald zurückgegeben werden.</p>
