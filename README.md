# Schramowski Getränke – Drink Reservations

Internal Laravel app to manage **drink reservations**.
...
- `APP_VERSION` (used in the UI/footer; default/base in `.env.example`: `1.0.0`)
